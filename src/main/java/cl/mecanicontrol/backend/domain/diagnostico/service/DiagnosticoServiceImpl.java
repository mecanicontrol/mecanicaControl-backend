...
import cl.mecanicontrol.backend.domain.diagnostico.repository.DiagnosticoRepository;
import cl.mecanicontrol.backend.domain.diagnostico.service.external.GroqService;
import cl.mecanicontrol.backend.domain.servicioCatalogo.repository.ServicioCatalogoRepository;
